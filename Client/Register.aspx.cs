...
public partial class Client_Register : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        con.Open();
        String s = "insert into UserInfo(user_fname,user_lname,user_mail,user_pass,user_address,user_city,user_pin,user_state,user_country,user_cdate) values(@user_fname,@user_lname,@user_mail,@user_pass,@user_address,@user_city,@user_pin,@user_state,@user_country,@user_cdate)";
